...
imageA = cv2.imread('./stitching/s1.jpg')  # 오른쪽 사진
imageA = cv2.resize(imageA, (1246, 700))
imageB = cv2.imread('./stitching/s2.jpg')  # 왼쪽 사진
imageB = cv2.resize(imageB, (1246, 700))
...
H, status = cv2.findHomography(src, dst, cv2.RANSAC, 1.0)
