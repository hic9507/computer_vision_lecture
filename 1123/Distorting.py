...
camera_matrix = np.load('C:/Users/user/Desktop/computer_vision/final/image/camera_mat.npy')
dist_coefs = np.load('C:/Users/user/Desktop/computer_vision/final/image/dist_coefs.npy')

# img = cv2.imread('./pinhole_calib/img_00.png')
img = cv2.imread('C:/Users/user/Desktop/computer_vision/final/image/pinhole_calib/bs_1.jpg')
pattern_size = (10, 7)
...
cv2.imshow('undistored corners', img)
cv2.waitKey()
